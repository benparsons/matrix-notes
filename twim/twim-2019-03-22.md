...
> I love that you've got Amazon doing Alexa messaging, Apple trying hard with iMessage, FB trying 3 ways to do chat, Google trying 50 ways to do chat, before you even get into things like Slack, Discord, Telegram, Riot, Line, WeChat etc etc. And then the current hot way to chat is in a document.  
